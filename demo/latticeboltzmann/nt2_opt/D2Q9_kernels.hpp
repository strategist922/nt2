               ...
               )
{
  ...
  out(_,_,2) = a*in(_,_,1)+c*in(_,_,2)-b*in(_,_,4)-T(2.)*b*in(_,_,5)-T(2.)*d*in(_,_,6)+e*in(_,_,8);
  out(_,_,3) = a*in(_,_,1)+c*in(_,_,3)-b*in(_,_,4)-T(2.)*b*in(_,_,5)-T(2.)*d*in(_,_,7)-e*in(_,_,8);
  out(_,_,4) = a*in(_,_,1)-c*in(_,_,2)-b*in(_,_,4)-T(2.)*b*in(_,_,5)+T(2.)*d*in(_,_,6)+e*in(_,_,8);
  out(_,_,5) = a*in(_,_,1)-c*in(_,_,3)-b*in(_,_,4)-T(2.)*b*in(_,_,5)+T(2.)*d*in(_,_,7)-e*in(_,_,8);
