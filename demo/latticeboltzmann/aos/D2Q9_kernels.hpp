...
{
    f_loc(1) = f(1,i,j);
    f_loc(2) = (i>1)  ? f(2, i-1 , j)    : T(0.);
    f_loc(3) = (j>1)  ? f(3, i   , j-1)  : T(0.);
    f_loc(4) = (i<nx) ? f(4, i+1 , j)    : T(0.);
    f_loc(5) = (j<ny) ? f(5, i   , j+1 ) : T(0.);
    f_loc(6) = (i>1 && j>1)  ? f(6, i-1 , j-1) : T(0.);
    f_loc(7) = (i<nx && j>1) ? f(7, i+1 , j-1) : T(0.);
    f_loc(8) = (i<nx && j<ny)? f(8, i+1 , j+1) : T(0.);
    f_loc(9) = (i>1 && j<ny) ? f(9, i-1 , j+1) : T(0.);
}
