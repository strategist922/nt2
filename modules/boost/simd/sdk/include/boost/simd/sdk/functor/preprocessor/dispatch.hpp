...
BOOST_DISPATCH_REGISTER((boost)(simd)(BOOST_SIMD_EXT_NS),Tag,Site,Types,Seq)

#define BOOST_SIMD_REGISTER_DISPATCH_TPL(Tag,Site,Types,Seq)                   \
BOOST_DISPATCH_REGISTER_TPL((boost)(simd)(BOOST_SIMD_EXT_NS),Tag,Site,Types,Seq)

#define BOOST_SIMD_REGISTER_DISPATCH_TO(Tag,Site,Types,Seq,Ret)                \
BOOST_DISPATCH_REGISTER_TO((boost)(simd)(BOOST_SIMD_EXT_NS),Tag,Site,Types,Seq,Ret)

#define BOOST_SIMD_REGISTER_DISPATCH_TO_IF(Tag,Site,Types,Cond,Seq,Ret)        \
BOOST_DISPATCH_REGISTER_TO_IF((boost)(simd)(BOOST_SIMD_EXT_NS),Tag,Site,Types,Cond,Seq,Ret)

#define BOOST_SIMD_REGISTER_DISPATCH_TO_TPL(Tag,Site,Types,Seq,Ret)            \
BOOST_DISPATCH_REGISTER_TO_TPL((boost)(simd)(BOOST_SIMD_EXT_NS),Tag,Site,Types,Seq,Ret)

#define BOOST_SIMD_REGISTER_DISPATCH_IF(Tag,Site,Types,Cond,Seq)               \
BOOST_DISPATCH_REGISTER_IF((boost)(simd)(BOOST_SIMD_EXT_NS),Tag,Site,Types,Cond,Seq)

#define BOOST_SIMD_REGISTER_DISPATCH_IF_TPL(Tag,Site,Types,Cond,Seq)           \
BOOST_DISPATCH_REGISTER_IF_TPL((boost)(simd)(BOOST_SIMD_EXT_NS),Tag,Site,Types,Cond,Seq)
