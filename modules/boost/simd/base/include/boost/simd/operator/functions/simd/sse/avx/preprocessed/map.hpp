...
{
  } } } namespace boost { namespace dispatch { namespace meta { template< class Func , class A0 > BOOST_FORCEINLINE :: boost :: simd :: ext :: implement< boost::simd::tag::map_ ( unspecified_<Func> , simd_< unspecified_<A0>, boost::simd::tag::avx_ > ) , boost::simd::tag::avx_ > dispatching( boost::simd::tag::map_, boost::simd::tag::avx_ , unspecified_<Func> const , simd_< unspecified_<A0>, boost::simd::tag::avx_ > const , adl_helper = adl_helper() ) { return :: boost :: simd :: ext :: implement< boost::simd::tag::map_ ( unspecified_<Func> , simd_< unspecified_<A0>, boost::simd::tag::avx_ > ) , boost::simd::tag::avx_ >(); } } } } namespace boost { namespace simd { namespace BOOST_SIMD_EXT_NS { template< class Func , class A0 > struct implement< boost::simd::tag::map_ ( unspecified_<Func> , simd_< unspecified_<A0>, boost::simd::tag::avx_ > ) , boost::simd::tag::avx_ >
  {
  ...
  } } } namespace boost { namespace dispatch { namespace meta { template< class Func , class A0 , class A1 > BOOST_FORCEINLINE :: boost :: simd :: ext :: implement< boost::simd::tag::map_ ( unspecified_<Func> , simd_< unspecified_<A0>, boost::simd::tag::avx_ > , simd_< unspecified_<A1>, boost::simd::tag::avx_ > ) , boost::simd::tag::avx_ > dispatching( boost::simd::tag::map_, boost::simd::tag::avx_ , unspecified_<Func> const , simd_< unspecified_<A0>, boost::simd::tag::avx_ > const , simd_< unspecified_<A1>, boost::simd::tag::avx_ > const , adl_helper = adl_helper() ) { return :: boost :: simd :: ext :: implement< boost::simd::tag::map_ ( unspecified_<Func> , simd_< unspecified_<A0>, boost::simd::tag::avx_ > , simd_< unspecified_<A1>, boost::simd::tag::avx_ > ) , boost::simd::tag::avx_ >(); } } } } namespace boost { namespace simd { namespace BOOST_SIMD_EXT_NS { template< class Func , class A0 , class A1 > struct implement< boost::simd::tag::map_ ( unspecified_<Func> , simd_< unspecified_<A0>, boost::simd::tag::avx_ > , simd_< unspecified_<A1>, boost::simd::tag::avx_ > ) , boost::simd::tag::avx_ >
  {
    typedef typename dispatch::meta::
