...
namespace boost { namespace simd { namespace BOOST_SIMD_EXT_NS
{
  ...
  } } } namespace boost { namespace dispatch { namespace meta { template< class Tag , class A0 > BOOST_FORCEINLINE typename boost::enable_if< mpl::not_< any < mpl::or_ < boost::proto:: is_expr<mpl::_> , boost::dispatch:: meta::is_proxy<mpl::_> > , A0 > > , boost::simd::ext::splat_or_map1< Tag, A0 > >::type dispatching( elementwise_<Tag>, tag::formal_ , unspecified_<A0> const , adl_helper = adl_helper() ) { return boost::simd::ext::splat_or_map1< Tag, A0 >(); } } } } namespace boost { namespace simd { namespace BOOST_SIMD_EXT_NS {
  ...
  } } } namespace boost { namespace dispatch { namespace meta { template< class Tag , class A0 , class A1 > BOOST_FORCEINLINE typename boost::enable_if< mpl::not_< any < mpl::or_ < boost::proto:: is_expr<mpl::_> , boost::dispatch:: meta::is_proxy<mpl::_> > , A0 , A1 > > , boost::simd::ext::splat_or_map2< Tag, A0 , A1 > >::type dispatching( elementwise_<Tag>, tag::formal_ , unspecified_<A0> const , unspecified_<A1> const , adl_helper = adl_helper() ) { return boost::simd::ext::splat_or_map2< Tag, A0 , A1 >(); } } } } namespace boost { namespace simd { namespace BOOST_SIMD_EXT_NS {
  ...
  } } } namespace boost { namespace dispatch { namespace meta { template< class Tag , class A0 , class A1 , class A2 , class A3 , class A4 > BOOST_FORCEINLINE typename boost::enable_if< mpl::not_< any < mpl::or_ < boost::proto:: is_expr<mpl::_> , boost::dispatch:: meta::is_proxy<mpl::_> > , A0 , A1 , A2 , A3 , A4 > > , boost::simd::ext::splat_or_map5< Tag, A0 , A1 , A2 , A3 , A4 > >::type dispatching( elementwise_<Tag>, tag::formal_ , unspecified_<A0> const , unspecified_<A1> const , unspecified_<A2> const , unspecified_<A3> const , unspecified_<A4> const , adl_helper = adl_helper() ) { return boost::simd::ext::splat_or_map5< Tag, A0 , A1 , A2 , A3 , A4 >(); } } } } namespace boost { namespace simd { namespace BOOST_SIMD_EXT_NS {
