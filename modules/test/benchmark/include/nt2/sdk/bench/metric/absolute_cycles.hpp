...
//==============================================================================
#ifndef NT2_SDK_BENCH_METRIC_ABSOLUTE_CYCLES_HPP_INCLUDED
#define NT2_SDK_BENCH_METRIC_ABSOLUTE_CYCLES_HPP_INCLUDED
...
namespace nt2 { namespace bench
{
  ...
  **/
  template<typename Stat> struct absolute_cycles
  {
