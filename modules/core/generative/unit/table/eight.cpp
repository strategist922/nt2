...
NT2_TEST_CASE( hierarchy )
{
  ...
  NT2_TEST_EXPR_TYPE( (nt2::tag::Eight() )
                    ...
                    , (nt2::BOOST_SIMD_EXT_NS::pure_constant_< nt2::tag::Eight >
                      )
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::Eight() )
                    , (nth_hierarchy<_,int_<2> >)
                    , (nt2::BOOST_SIMD_EXT_NS::constant_< nt2::tag::Eight >
                      )
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::Eight() )
                    , (nth_hierarchy<_,int_<3> >)
                    , (nt2::BOOST_SIMD_EXT_NS::elementwise_<nt2::tag::Eight>)
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::Eight() )
                    , (nth_hierarchy<_,int_<4> >)
                    , (nt2::BOOST_SIMD_EXT_NS::unspecified_<nt2::tag::Eight>)
                    );
}
