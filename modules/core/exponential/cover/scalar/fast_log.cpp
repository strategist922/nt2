...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 exponential toolbox - fast_log/scalar Mode"
...
NT2_TEST_CASE_TPL ( fast_log_real__1_0,  NT2_REAL_TYPES)
{
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::fast_log(a0),::cephes_logl(a0),0.5);
