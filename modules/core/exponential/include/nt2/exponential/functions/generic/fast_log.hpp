...
//==============================================================================
#ifndef NT2_EXPONENTIAL_FUNCTIONS_GENERIC_FAST_LOG_HPP_INCLUDED
#define NT2_EXPONENTIAL_FUNCTIONS_GENERIC_FAST_LOG_HPP_INCLUDED

#include <nt2/exponential/functions/fast_log.hpp>
...
{
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::fast_log_, tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return nt2::fast_log(nt2::tofloat(a0));
    }
  };
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return details::fast_logarithm<A0,is_native_t>::log(a0);
    }
  };
