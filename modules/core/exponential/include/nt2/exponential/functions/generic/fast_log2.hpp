...
//==============================================================================
#ifndef NT2_EXPONENTIAL_FUNCTIONS_GENERIC_FAST_LOG2_HPP_INCLUDED
#define NT2_EXPONENTIAL_FUNCTIONS_GENERIC_FAST_LOG2_HPP_INCLUDED

#include <nt2/exponential/functions/fast_log2.hpp>
...
{
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::fast_log2_, tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE NT2_FUNCTOR_CALL(1)
    {
      return details::fast_logarithm<A0,is_native_t>::log2(a0);
    }
  };
