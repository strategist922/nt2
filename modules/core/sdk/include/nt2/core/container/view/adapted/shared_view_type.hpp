...
//==============================================================================
#ifndef NT2_CORE_CONTAINER_VIEW_ADAPTED_SHARED_VIEW_TYPE_HPP_INCLUDED
#define NT2_CORE_CONTAINER_VIEW_ADAPTED_SHARED_VIEW_TYPE_HPP_INCLUDED
...
{
  template<typename Container, bool Own = false>
  struct shared_view_type
  {
    // Base container type
    ...
    typedef memory::container_shared_ref< kind_type
                                        , value_type
                                        , settings_type
                                        , Own
                                        >                       container_ref;
  ...
  template<typename Container, bool Own>
  struct shared_view_type<Container const,Own>
  {
    // Base container type
    typedef typename meta::kind_<Container>::type               kind_type;
    typedef typename meta::value_type_<Container>::type         value_type;
