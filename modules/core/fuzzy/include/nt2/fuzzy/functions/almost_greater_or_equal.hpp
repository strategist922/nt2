...
namespace nt2 { namespace tag
  {
   /*!
     ...
     @par Models:
        Hierarchy
   **/
    struct almost_greater_or_equal_ : BOOST_SIMD_EXT_NS::elementwise_<almost_greater_or_equal_>
    {
      /// @brief Parent hierarchy
      typedef BOOST_SIMD_EXT_NS::elementwise_<almost_greater_or_equal_> parent;
    };
  }
  /*!
