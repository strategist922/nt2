...
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  ...
  if(APPLE)
    set(NT2_FLAGS_TEST "${NT2_FLAGS_TEST} -DUSE_UBSAN -fsanitize=undefined-trap -fno-sanitize=float-cast-overflow,float-divide-by-zero,shift,signed-integer-overflow,unsigned-integer-overflow -fsanitize-undefined-trap-on-error")
  else()
    set(SANITIZE_FLAGS "-fsanitize=address,undefined-trap -fno-sanitize=float-cast-overflow,float-divide-by-zero,shift,signed-integer-overflow,unsigned-integer-overflow -fno-sanitize-recover")
