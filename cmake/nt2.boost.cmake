...
if(NOT Boost_FOUND)
  ...
  if(Boost_VERSION LESS 105900)
    message(STATUS "[nt2] Boost version ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION} not recent enough, needs 1.59.0")
    set(Boost_FOUND 0)
  endif()
  if(Boost_FOUND)
